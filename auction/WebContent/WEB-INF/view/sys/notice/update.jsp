...
<div id="main">
<s:form action="ProcessUpdate" method="post" namespace="/notice/admin" enctype="multipart/form-data">
<table class="detail_table">
<tr><th>标题</th><td><s:textfield name="notice.title" value="%{user_notice.notice.title}"/></td></tr>
<tr><th>消息来源</th><td><s:textfield name="notice.source" value="%{user_notice.notice.source}"/></td></tr>
<tr><th>显示状态</th><td><s:radio name="notice.status" list="@sus.scrofa.action.CommonAction@MAP_NOTICE_STATUS" 
listKey="key" listValue="value" value="%{user_notice.notice.status}"/></td></tr>
<tr><th>置顶级别</th><td><s:radio name="notice.topLevel" list="@sus.scrofa.action.CommonAction@MAP_NOTICE_TOP" 
listKey="key" listValue="value" value="%{user_notice.notice.topLevel}"/></td></tr>
<tr><th>具体内容</th><td><s:textarea name="notice.content" value="%{user_notice.notice.content}"/></td></tr>
<tr><td class="center_td" colspan="2"><s:submit value="修改"></s:submit></td></tr>
</table>
<s:hidden name="id" value="%{user_notice.notice.id}" />
</s:form>
</div>
</div>
</div>
