...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/regist.personal.css" />
...
<div class="mt">
    <h2>注册新用户</h2>
    <b></b><span style="text-align: right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> <span>我已经注册，现在就&nbsp;<s:a action="Login" namespace="/" cssClass="flk13">登录</s:a></span>
</div>
<div class="mc">
<ul class="tab">
...
<s:form action="ProcessRegister" namespace="/user" id="formpersonal" method="POST">
    <div class="form">
        <div class="item">
            <span class="label"><b class="ftx04">*</b>用户名：</span>
            <div class="fl">
            	<s:textfield id="username" name="user.name" cssClass="text" tabindex="1"/>
        ...
        <div id="o-password">
            <div class="item">
                ...
                <div class="fl">
                	<s:password id="pwd" name="user.password" cssClass="text" tabindex="2" style="ime-mode:disabled;"/>
            ...
            <div class="item">
                ...
                <div class="fl">
                	<s:password id="pwd2" name="confirmPassword" cssClass="text" tabindex="3"/>
        ...
        <div class="item">
            ...
            <div class="fl">
            	<s:textfield id="mail" name="user.email" cssClass="text" tabindex="4"/>
        ...
        <div class="item" style="display: none">
            ...
            <div class="fl">
                <input type="text" id="authcode" style="ime-mode:disabled" name="authcode" class="text text-1" tabindex="6" maxlength="6">
                <label class="img">
                    <img style="cursor:pointer;width:100px;height:26px;display:block;" alt="" id="JD_Verification1" src="#"> </label>
        ...
        <div class="item">
            ...
            <input type="button" class="btn-img btn-regist" id="registsubmit" value="同意以下协议，提交" tabindex="8" onclick="javascript:submit()">
        </div>
    </div>
</s:form>
